  ...
  return (
    <Container>
      <div className='container p-5 text-center' id='frente'>
        <p style={{ color: "#6061df", marginTop: "230px" }}>Know everyone through this instrument, that the Academic Council of Ivy Enber Christian University, by the virtue
        ...
        <div className='row'>
          ...
          <img style={{ width: '100px', height: '40px' }} src={assinatura_ozemar} />
            <p style={{ borderTop: "1px solid black" }}>Ozemar Da Silva Araújo Academic Director</p>
          </div>
          <div className='col-md-6 p-3'>
