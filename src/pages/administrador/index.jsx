// import { FaUserGraduate, FaLayerGroup, FaRegEdit, FaRegPlusSquare, FaRegSave, FaPencilAlt, FaShieldAlt, FaWpforms, FaClipboardList, FaBookMedical, FaBookReader, FaRegWindowClose, FaPlus } from 'react-icons/fa';
...
// 									</Modal.Body>
// 									<Modal.Footer>
// 										{parseInt(this.state.id_tipoChamado) !== 0 ?
...
import useFetchPermissoes from '../../hooks/useFetchPermissoes';

const Index = () => {
    const { usuarios, loading, error } = useFetchUsuarios();
    const { permissoes } = useFetchPermissoes();
    ...
    return (
        <Container fluid style={{
            ...
            <Row>
                <Col xs={12} id="main">
                    <MainContent>
                        ...
                        <div className="container mt-4 mb-4">
                            <Tabs defaultActiveKey="home" id="tab-menu-admin" className="justify-content-center mb-3" variant="pills">
                                <Tab eventKey="home" title="Usuários">
                                    <h2 className="lead text-light">Usuários</h2>
                                    <UserTable usuarios={usuarios} onEdit={handleEditUser} />
                                </Tab>
                                {/* Outros Tabs... */}
                            </Tabs>
                        </div>
            ...
            <UserModal show={showUserModal} onHide={handleHideUserModal} user={selectedUser} />
        </Container>
    );
};
